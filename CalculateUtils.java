 ...
 * ***********************
 * 
 * Програмування паралельний комп'ютерних
 * сисем Курсова робота. ПРГ2. Бібліотека MPI
 * 
 * Завдання: A = B(MO*MK)*a + min(Z)*E*MR
 * 
 * Файл CalculateUtils.java Автор Кузьменко Володимир
 * Група ІО-21 Датаe 23.04.15
 * 
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * ************************
 */
